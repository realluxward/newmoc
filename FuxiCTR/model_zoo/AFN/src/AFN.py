...
class AFN(BaseModel):
    def __init__(self, 
        ...
        if self.mix:
            ...
            *[
                ...
                nn.Linear(input_dim//64, input_dim),
            ]
            )
    ...
    def forward(self, inputs):
        ...
        if self.ensemble_dnn:
            ...
            if self.mix:
                bs = feature_emb2.shape[0]
                feature_emb2 = feature_emb2.reshape(bs, -1, 64)
                flat_feature_emb2 = feature_emb2.flatten(start_dim=1)
                flat_feature_emb2 = flat_feature_emb2 + self.gating2(flat_feature_emb2)
                feature_emb2 = flat_feature_emb2.reshape(bs, -1, 64)
