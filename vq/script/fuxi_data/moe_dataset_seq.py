...
index_path = f"/apdcephfs_cq10/share_1362653/taolinzhang/rs/vector-quantize-pytorch/ckpt/{split_dataset}/moe_{n_cluster}_{7}_index.pt"
...
root = f"{dataset_path}/{split_dataset}-moe-{keep_num}-seq"
            ...
            if item_id in item_cluster_id_dict.keys():
                ...
                for i in range(expert_nums):
                    if i< keep_num:
                        ...
                        write_f.write(f",{moe_cid[keep_num-1]}")
