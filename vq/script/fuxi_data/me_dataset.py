...
# keep_num = int(sys.argv[1]) 
index_path = f"../moe/ckpt/{split_dataset}/moe_{n_cluster}_{1}_index.pt"
...
fuxi = "/data2/wangzhongren/taolin_project/FuxiCTR"
dataset_path = f"{fuxi}/data"
root = f"{dataset_path}/{split_dataset}-me"
bole = "/data2/wangzhongren/taolin_project/dataset"
