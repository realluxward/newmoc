...
index_path = f"/apdcephfs_cq10/share_1362653/taolinzhang/rs/vector-quantize-pytorch/ckpt/{split_dataset}/rq_{n_cluster}_{7}_index.pt"
...
root = f"{dataset_path}/{split_dataset}-rq-{keep_num}-seq"
